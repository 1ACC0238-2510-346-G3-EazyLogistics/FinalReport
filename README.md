...
Para el desarrollo del informe perteneciente a la entrega TB2, se dividio la implementacion de secciones de la siguiente forma por cada integrante del equipo

| Integrante                            | Tareas Asignadas                                                                                                                           |
| ------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------ |
| Vasquez Requejo Augusto Mathias Leonardo  | Android Studio ,Flutter, informe y Back end              |
| Pedraza Maldonado Joaquin Andree     |  Android Studio ,Flutter y Back end               |
| Luza Cahuamaca Jose Adrian       | Android Studio ,Flutter, informe y Back end              |
| Braithuaite Toledo Gabriel Anthony  | Android Studio ,Flutter, informe y Back end               |
| Reyes Trujillano Fabian Alonso |  ,Flutter, informe y Back end              |
