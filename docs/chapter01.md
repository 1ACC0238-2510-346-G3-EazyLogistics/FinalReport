...
| Joaquin Andree Pedraza Maldonado | 6to Ciclo 2024-2 Universidad Peruana de Ciencias Aplicada | Imagen  | - Conocimientos en lenguajes de programación como C++, Python, Html y CSS. Considero que que soy responsable y dedicado. A la vez, colaboraré siempre con ideas para poder lograr un buen trabajo en equipo.|
